...
[code_blocks, number_of_code_blocks, K, Z_c, N, G] = cb_segment_and_cb_crc_attach(transport_block_with_crc, ldpc_base_graph);
...
rate_matching_output_sequence_lengths = bit_selection_calculate(modulation_order, ...
             G, ...
             number_of_layers, ...
